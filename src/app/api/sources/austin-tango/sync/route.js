...
const SOURCE_ID = 'austin-tango';
const CALENDAR_ID = 'aiusn8ua5aq0fn2hqavnlabvpg@group.calendar.google.com';
const SOURCE_URL = `https://calendar.google.com/calendar/ical/${encodeURIComponent(
  CALENDAR_ID
)}/public/basic.ics`;
const CITY_NAME = 'Austin';
const CITY_SLUG = 'austin';
const CITY_TIMEZONE = 'America/Chicago';
...
function detectEventType(text) {
  ...
  if (/practic(a|e)/i.test(text)) return 'practica';
