...
const SOURCE_ID = 'hoymilonga-buenos-aires';
const SOURCE_URL = 'https://www.hoy-milonga.com/buenos-aires/en/milongas';
const SOURCE_BASE = 'https://www.hoy-milonga.com';
const CITY_NAME = 'Buenos Aires';
const CITY_SLUG = 'buenos-aires';
const BUENOS_AIRES_TZ_OFFSET = '-03:00';
...
function getDayOfWeek(dateStr) {
  ...
  const date = new Date(`${dateStr}T00:00:00${BUENOS_AIRES_TZ_OFFSET}`);
