...
const handleAddToQueue = (tandaToAdd) => {
    ...
    return (
        <div className="p-4 bg-transparent text-white rounded-lg w-full max-w-[28rem] mx-auto font-sans">
            {menuState.visible && (
                <ContextMenu
